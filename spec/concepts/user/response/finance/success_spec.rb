...
describe User::Response::Finance::Success, response: true do
  ...
  describe '#success_respond' do
    include_examples '#success_respond', :send_message do
      ...
      before { allow(User::Render::Finance).to receive(:call).and_return(params) }
    end
  end
end