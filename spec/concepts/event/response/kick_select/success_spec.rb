...
describe Event::Response::KickSelect::Success, response: true do
  ...
  describe 'render Event::Render::Edit' do
    include_examples '#render' do
      ...
      let(:render) { Event::Render::KickSelect }
  ...
  describe '#success_respond' do
    ...
    describe 'users: 1, admins: 1' do
      include_examples '#success_respond', :answer_callback_query do
        let(:params) { { callback_query_id: 'id', text: 'No users to kick out', show_alert: true } }
      end
    end
